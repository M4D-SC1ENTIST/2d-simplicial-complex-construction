...
"""autogenerated by genpy from kr_tracker_msgs/BsplineTrackerAction.msg. Do not edit."""
import codecs
import sys
...
class BsplineTrackerAction(genpy.Message):
  _md5sum = "65c2e74106e5be1b70c78428d594a5a8"
  _type = "kr_tracker_msgs/BsplineTrackerAction"
...
"""
  ...
  _slot_types = ['kr_tracker_msgs/BsplineTrackerActionGoal','kr_tracker_msgs/BsplineTrackerActionResult','kr_tracker_msgs/BsplineTrackerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BsplineTrackerAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = kr_tracker_msgs.msg.BsplineTrackerActionGoal()
      if self.action_result is None:
        self.action_result = kr_tracker_msgs.msg.BsplineTrackerActionResult()
      if self.action_feedback is None:
        self.action_feedback = kr_tracker_msgs.msg.BsplineTrackerActionFeedback()
    else:
      self.action_goal = kr_tracker_msgs.msg.BsplineTrackerActionGoal()
      self.action_result = kr_tracker_msgs.msg.BsplineTrackerActionResult()
      self.action_feedback = kr_tracker_msgs.msg.BsplineTrackerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_iq2Ib().pack(_x.action_goal.goal.order, _x.action_goal.goal.traj_id, _x.action_goal.goal.start_time.secs, _x.action_goal.goal.start_time.nsecs, _x.action_goal.goal.status))
      ...
      _x = self
      buff.write(_get_struct_d3I().pack(_x.action_goal.goal.yaw_dt, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.order, _x.action_goal.goal.traj_id, _x.action_goal.goal.start_time.secs, _x.action_goal.goal.start_time.nsecs, _x.action_goal.goal.status,) = _get_struct_iq2Ib().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      (_x.action_goal.goal.yaw_dt, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.knots = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.pos_pts = []
...
def _get_struct_d3I():
    ...
    return _struct_d3I
_struct_iq2Ib = None
def _get_struct_iq2Ib():
    global _struct_iq2Ib
    if _struct_iq2Ib is None:
        _struct_iq2Ib = struct.Struct("<iq2Ib")
    return _struct_iq2Ib
