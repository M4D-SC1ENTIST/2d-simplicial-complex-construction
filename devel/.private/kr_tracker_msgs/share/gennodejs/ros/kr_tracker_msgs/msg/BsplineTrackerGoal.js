...
class BsplineTrackerGoal {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BsplineTrackerGoal(null);
  ...
  static datatype() {
    ...
    return 'kr_tracker_msgs/BsplineTrackerGoal';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '76b47ae60907a000233eee645154a4ff';
  }
  ...
  static messageDefinition() {
    ...
    int64 traj_id
    time start_time
    int8 status # 0 is new, 1 is replan, 2 is bspline 
    float64[] knots
  ...
  static Resolve(msg) {
    ...
    const resolved = new BsplineTrackerGoal(null);
...
module.exports = BsplineTrackerGoal;
